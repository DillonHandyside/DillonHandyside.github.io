    ...
    <div id='cv'>
        <div className='cv-button-group'>
            <div className='cv-button'>
                <img src={DarkThumbnail} />
                <a href={DarkCV} download className='btn'><FiDownload /> CV (Dark)</a>
            </div>
            <div className='cv-button'>
                <img src={LightThumbnail} />
                <a href={LightCV} download className='btn'><FiDownload /> CV (Light)</a>
            </div>
        </div>
    </div>
  )
